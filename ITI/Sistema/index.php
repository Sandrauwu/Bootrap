...
<head>
	...
	<title>UPV - Agustín Zavala Arias</title>
			...
			<div class="sidebar-content">
				...
				<div class="sidebar-user">
					<div class="card-body">
						<div class="media">
							...
							<div class="media-body">
								<div class="media-title font-weight-semibold">Ana Zavala</div>
				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<!-- Forms -->
						<li class="nav-item-header"><div class="text-uppercase font-size-xs line-height-xs">Menús</div> <i class="icon-menu" title="Forms"></i></li>
						<li class="nav-item nav-item-submenu">
							<!--
					...
					-->
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Form layouts">
								<li class="nav-item"><a href="formulario_alumnos.html" class="nav-link">Añadir</a></li>
								
								<li class="nav-item"><a href="editar_alumnos.html" class="nav-link">Editar</a></li>
								
								<li class="nav-item"><a href="eliminar_alumno.html" class="nav-link">Eliminar</a></li>
								
								<li class="nav-item"><a href="datatable_Alumnos.html" class="nav-link">Visualizar</a></li>
						...
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-pen"></i> <span>Maestros</span></a>
							<ul class="nav nav-group-sub" data-submenu-title="Form layouts">
								<li class="nav-item"><a href="formulario_maestros.html" class="nav-link">Añadir</a></li>
								
								<li class="nav-item"><a href="editar_maestros.html" class="nav-link">Editar</a></li>
								
								<li class="nav-item"><a href="eliminar_maestro.html" class="nav-link">Eliminar</a></li>
								
								<li class="nav-item"><a href="datatable_Maestros.html" class="nav-link">Visualizar</a></li>
							</ul>
						</li>
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-atom2"></i> <span>Materia</span></a>
							<ul class="nav nav-group-sub" data-submenu-title="Form layouts">
								<li class="nav-item"><a href="formulario_materia.html" class="nav-link">Añadir</a></li>
								
								<li class="nav-item"><a href="editar_materia.html" class="nav-link">Editar</a></li>
								
								<li class="nav-item"><a href="eliminar_materia.html" class="nav-link">Eliminar</a></li>
								
								<li class="nav-item"><a href="datatable_materia.html" class="nav-link">Visualizar</a></li>
							</ul>
						</li>
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-list-unordered"></i> <span>Cuatrimestre</span></a>
							<ul class="nav nav-group-sub" data-submenu-title="Form layouts">
								<li class="nav-item"><a href="formulario_cuatrimestre.html" class="nav-link">Añadir</a></li>
								
								<li class="nav-item"><a href="editar_cuatrimestre.html" class="nav-link">Editar</a></li>
								
								<li class="nav-item"><a href="eliminar_cuatrimestre.html" class="nav-link">Eliminar</a></li>
								
								<li class="nav-item"><a href="datatable_cuatrimestre.html" class="nav-link">Visualizar</a></li>
							</ul>
						</li>
						<!-- /forms -->
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Data tables">
								<li class="nav-item"><a href="datatable_Alumnos.html" class="nav-link">Visualizacion Alumnos</a></li>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home</span> - Inicio</h4>
			...
			<div class="content">
				...
				<div class="row">
					...
					<div class="col-xl-5">
						...
						<div class="card">
							<div class="card-header header-elements-inline">
								<h6 class="card-title">Estadisticas de usuario</h6>
								<div class="header-elements">
									<select class="form-control" id="select_date" data-fouc>
										<option value="val1">1 Junio - 30 Junio</option>
										<option value="val2">1 Julio - 31 Julio</option>
										<option value="val3" >1 Agosto - 31 Agosto</option>
										<option value="val4" selected>1 Septiembre - 30 Septiembre</option>
									</select>
			                	</div>
							</div>
							...
							<div class="card-body py-0">
								<div class="row text-center">
									<div class="col-4">
										<div class="mb-3">
											<h5 class="font-weight-semibold mb-0">2,200</h5>
											<span class="text-muted font-size-sm">Nuevos Usuarios</span>
										</div>
									</div>

									<div class="col-4">
										<div class="mb-3">
											<h5 class="font-weight-semibold mb-0">10,580</h5>
											<span class="text-muted font-size-sm">Entradas Este Mes</span>
										</div>
									</div>

									<div class="col-4">
										<div class="mb-3">
											<h5 class="font-weight-semibold mb-0">150,000</h5>
											<span class="text-muted font-size-sm">Entradas Totales</span>
										</div>
									</div>
								</div>
							</div>
					...
					<!-- My messages -->
						<div class="card">
							<div class="card-header header-elements-inline">
								<h6 class="card-title">Mis mensajes</h6>
								<div class="header-elements">
									<span><i class="icon-history text-warning mr-2"></i> 14 de octubre, 17:00</span>
							...
							<div class="card-body py-0">
								<div class="row text-center">
									...
									<div class="col-4">
										<div class="mb-3">
											<h5 class="font-weight-semibold mb-0">170</h5>
									...
									<div class="col-4">
										<div class="mb-3">
											<h5 class="font-weight-semibold mb-0">1,258</h5>
									...
									<ul class="media-list">
										...
										<li class="media">
											...
											<div class="media-body">
												...
												Hola, para registrarlos en el eclass
											</div>
										</li>
					...
					<div class="col-xl-8">
						...
						<div class="row">
							<div class="col-lg-4">
								...
								<div class="card bg-teal-400">
									<div class="card-body">
										<div class="d-flex">
											<h3 class="font-weight-semibold mb-0">70</h3>
											<span class="badge bg-teal-800 badge-pill align-self-center ml-auto">+3,6%</span>
					                	</div>
					                	
					                	<div>
											Miembros en linea
											<div class="font-size-sm opacity-75">120 avg</div>
										</div>
									</div>
										...
										<div class="d-flex">
											...
											<div class="list-icons ml-auto">
						                		<div class="list-icons-item dropdown">
													...
													<div class="dropdown-menu dropdown-menu-right">
														<a href="#" class="dropdown-item"><i class="icon-sync"></i> Actualizar datos</a>
														<a href="#" class="dropdown-item"><i class="icon-list-unordered"></i> Datos detallados</a>
														<a href="#" class="dropdown-item"><i class="icon-pie5"></i> Estadisticas</a>
														<a href="#" class="dropdown-item"><i class="icon-cross3"></i> Limpiar listas</a>
													</div>
						                		</div>
					                		</div>
					                	</div>
						...
						<div class="card">
							...
							<div class="list-group list-group-flush">
								<a href="#" class="list-group-item list-group-item-action">
									...
									Calendario_escolar.pdf <span class="badge bg-success-400 ml-auto">New</span>
								</a>

								<a href="#" class="list-group-item list-group-item-action">
									<i class="icon-file-word mr-3"></i>
									Informacion_becas.docx
								</a>

								<a href="#" class="list-group-item list-group-item-action">
									<i class="icon-file-word mr-3"></i>
									Informacion_ingles.docx
								</a>

								<a href="#" class="list-group-item list-group-item-action">
									<i class="icon-arrow-right22 mr-3"></i>
									Muestra todos los archivos (93)
								</a>
							</div>
						</div>
						<!-- /list of files -->
						...
						<div class="card">
							<div class="card-header header-elements-inline">
								...
								<div class="header-elements">
									<span class="badge bg-indigo-400">3 nuevas</span>
								</div>
							</div>
							...
							<div class="card-body">
								<ul class="media-list mb-3">
									<li class="media">
										...
										<div class="media-body">
											<h6 class="media-title">
												<label for="task1" class="font-weight-semibold cursor-pointer mb-0">PseInt</label>
											</h6>
									...
									<li class="media">
										...
										<div class="media-body">
											<h6 class="media-title">
												<label for="task2" class="font-weight-semibold cursor-pointer mb-0">Algebra</label>
											</h6>
									...
									<li class="media">
										...
										<div class="media-body">
											<h6 class="media-title">
												<label for="task3" class="font-weight-semibold cursor-pointer mb-0">PowerPoint</label>
											</h6>

											Entregar video correspondiente
										</div>
									</li>

									<li class="media">
										<div class="media-body text-center">
											<a href="#" class="text-muted">Ver tareas completadas (16)</a>
										</div>
									</li>
								</ul>
		                    	...
		                    	<div class="d-flex align-items-center">
		                    		...
		                    		<button type="button" class="btn bg-pink-400 ml-auto">Añadir comentarios</button>
		                    	</div>
							</div>
						</div>
						<!-- /my tasks -->
					...
					<div class="col-xl-4">
						...
						<div class="row">
							...
							<div class="media mb-3">
								<div class="media-body">
									<h6 class="font-weight-semibold mb-0">Mantenimiento de Servidor</h6>
									<span class="text-muted">Programado a 1 de noviembre</span>
								</div>
						...
						<div class="card text-center bg-blue-400 has-bg-image">
							<div class="card-body">
								<h6 class="font-weight-semibold mb-0 mt-1">Estadisticas de las tareas</h6>
								<div class="opacity-75 mb-3">Tareas totales : 30</div>
							...
							<div class="card-body border-top-0 pt-0">
								<div class="row">
									<div class="col-4">
										<div class="text-uppercase font-size-xs">Aceptadas</div>
										<h5 class="font-weight-semibold line-height-1 mt-1 mb-0">20</h5>
									</div>

									<div class="col-4">
										<div class="text-uppercase font-size-xs">Denegadas</div>
										<h5 class="font-weight-semibold line-height-1 mt-1 mb-0">7</h5>
									</div>

									<div class="col-4">
										<div class="text-uppercase font-size-xs">Pendientes</div>
										<h5 class="font-weight-semibold line-height-1 mt-1 mb-0">3</h5>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="card">
							<div class="card-header header-elements-inline">
								<h6 class="card-title">Ultimas noticias</h6>
								<div class="header-elements">
								...
								<div class="row">
									<div class="col-xl-12">
										<div class="media flex-column flex-sm-row mt-0 mb-3">
				        					...
				        					<div class="media-body">
												<h6 class="media-title"><a href="#">Carrera aniversario</a></h6>
					                    		<ul class="list-inline list-inline-dotted text-muted mb-2">
					                    			<li class="list-inline-item"><i class="icon-book-play mr-2"></i> Video</li>
					                    		</ul>
												Los alumnos corrieron para celebrar el dia en que esta universidad empezo...
											</div>
										</div>
										...
										<div class="media flex-column flex-sm-row mt-0 mb-3">
				        					...
				        					<div class="media-body">
												<h6 class="media-title"><a href="#">Torneo de ajedrez</a></h6>
					                    		<ul class="list-inline list-inline-dotted text-muted mb-2">
					                    			<li class="list-inline-item"><i class="icon-book-play mr-2"></i> Video</li>
					                    		</ul>
												El torneo de ajedrez fue un exito, obtuvimos el primer puesto a nivel estatal...
											</div>
										</div>
									</div>
